...
4 / 77 testcases passed*/
    ...
    public void test() {
        ...
        fr = new FoodRatings(new String[]{"czopaaeyl","lxoozsbh","kbaxapl"},
                new String[]{"dmnuqeatj","dmnuqeatj","dmnuqeatj"}, new int[]{11,2,15});
        fr.changeRating("czopaaeyl",12);
        assertEquals("kbaxapl", fr.highestRated("dmnuqeatj"));
        fr.changeRating("kbaxapl",8);
        fr.changeRating("lxoozsbh",5);
        assertEquals("czopaaeyl", fr.highestRated("dmnuqeatj"));
